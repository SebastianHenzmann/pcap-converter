...
function AboutForm {
    ...
    $about_form.Text = 'About PCAP Converter v.1.1.1 (x64)'
    $about_form.Icon = $icon
    $about_form.Width = 305
    $about_form.Height = 340
    ...
    $GUIVersionLabel.Text = "GUI Version 1.1.1"
    ...
    #Code label
    $CopyrightLabel = New-Object System.Windows.Forms.Label
    $CopyrightLabel.Text = "Converter code by Fatman Makes $amp Brakes"
    $CopyrightLabel.Location = New-Object System.Drawing.Point(10, 205)
    $CopyrightLabel.AutoSize = $true
    $about_form.Controls.Add($CopyrightLabel)

    $YTLinkLabel = New-Object System.Windows.Forms.LinkLabel
    $YTLinkLabel.Location = New-Object System.Drawing.Size(50, 225)
    $YTLinkLabel.Size = New-Object System.Drawing.Size(80, 20)
    $YTLinkLabel.LinkColor = $White
    $YTLinkLabel.ActiveLinkColor = "yellow"
    $YTLinkLabel.VisitedLinkColor = $White
    $YTLinkLabel.Text = "YouTube"
    $YTLinkLabel.add_Click({ [system.Diagnostics.Process]::start("https://www.youtube.com/@fatmannmakesbreaks498") })
    $about_form.Controls.Add($YTLinkLabel)

    $PBLinkLabel = New-Object System.Windows.Forms.LinkLabel
    $PBLinkLabel.Location = New-Object System.Drawing.Size(185, 225)
    $PBLinkLabel.Size = New-Object System.Drawing.Size(80, 20)
    $PBLinkLabel.LinkColor = $White
    $PBLinkLabel.ActiveLinkColor = "yellow"
    $PBLinkLabel.VisitedLinkColor = $White
    $PBLinkLabel.Text = "Pastebin"
    $PBLinkLabel.add_Click({ [system.Diagnostics.Process]::start("https://pastebin.com/crWJ5PF4") })
    $about_form.Controls.Add($PBLinkLabel)

    $HashcatLinkLabel = New-Object System.Windows.Forms.LinkLabel
    $HashcatLinkLabel.Location = New-Object System.Drawing.Size(10, 245)
    ...
    $cap2hccapxLinkLabel.Location = New-Object System.Drawing.Size(99, 245)
    ...
    $RockyouLinkLabel.Location = New-Object System.Drawing.Size(210, 245)
    ...
    $CloseButton.Location = New-Object System.Drawing.Size(95, 270)
